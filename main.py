...
if __name__ == "__main__":
    ...
    sectionListRenderer = json_data['contents']['twoColumnBrowseResultsRenderer'][
        'tabs'][0]['tabRenderer']['content']['sectionListRenderer']['contents']
    for itemSectionRenderer in sectionListRenderer:
        print(itemSectionRenderer['itemSectionRenderer']
              ['contents'][0]['shelfRenderer']['title']['runs'])
        horizontalListRenderer = itemSectionRenderer['itemSectionRenderer'][
